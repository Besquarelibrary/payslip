...
from Employee_data.views import home, employeeDetails,getEmployeeById,Salary,ExpensesCompany,my_view,allExpensesDetails,Email
...
urlpatterns = [
    ...
    # path('salaryslip/',salaryslipsent,name='salaryslip')
    path('allexpenses/',allExpensesDetails,name='allexpenses'),
